        ...
        btn_update.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		try {
                    ...
                    preparedStmt.setInt(2, Integer.parseInt(textFieldTitle_view.getText()));
                    preparedStmt.setInt(3, Integer.parseInt(textFieldYear_view.getText()));
                    preparedStmt.setInt(4, Integer.parseInt(textFieldEdition_view.getText()));
                    preparedStmt.setString(5, textFieldAuthor_view.getText());
