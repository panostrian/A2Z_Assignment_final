...
public class FrmLibraryView extends JFrame {
    ...
    public FrmLibraryView() {
        ...
        btn_update.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		try {
                    String query = "UPDATE LIBRARY set LIBRARY_NAME = ?, LIBRARY = ? where TEACHER_ID = ?";
                    
                    Connection conn = DBconnector.getConnection();
                    PreparedStatement preparedStmt =conn.prepareStatement(query);
                    preparedStmt.setInt(1, Integer.parseInt(textFieldLibraryID_view.getText()));
                    preparedStmt.setString(2, textFieldLibraryName_view.getText());
                    preparedStmt.setString(3, textFieldAddress_view.getText());
                    preparedStmt.setInt(4, Integer.parseInt(textFieldPhone_view.getText()));
        		 ...
        		 try {
                     if (rs.first()){
                         ...
                         JOptionPane.showMessageDialog(null,
                                 "No further records found", "Empty result", JOptionPane.WARNING_MESSAGE);
                     }
        	...
        	public void actionPerformed(ActionEvent e) {
        		try {
                    if (rs.last()) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "No further records found", "Empty result",
        ...
        contentPane.add(panel);
                ...
                separator3.setBounds(66, 272, 429, 2);
